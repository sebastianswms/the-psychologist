package psychologistmod.characters;
...
import static psychologistmod.ThePsychologistMod.*;

public class ThePsychologist extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Psychologist"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_PSYCHOLOGIST;
        @SpireEnum(name = "PSYCHOLOGIST_MAROON_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "PSYCHOLOGIST_MAROON_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public ThePsychologist() {
        super(NAMES[0], Enums.THE_PSYCHOLOGIST,
